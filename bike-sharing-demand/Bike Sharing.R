setwd("C:/Users/supre/Desktop/bike-sharing-demand")
...
# creating  box plots on the count of rentals
boxplot(train$count~train$hour,xlab="hour", ylab=" Total count of users")
...
#using decision trees for binning some variables,really important step in feature engineering
...
# predicting missing values in wind speed using a random forest model
set.seed(415)
...
# We build different models for predicting for registered and casual users
